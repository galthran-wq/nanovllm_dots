"""nanovllm_dots.engine.block_manager
...
--------------------------------
:class:`~nanovllm_dots.engine.scheduler.Scheduler` is the only policy layer.
...
``nanovllm_dots/models/voxcpm/engine.py``, the sequence's ``token_ids``
