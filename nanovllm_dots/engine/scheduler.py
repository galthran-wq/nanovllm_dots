"""nanovllm_dots.engine.scheduler

This module implements the batching/scheduling policy for the inference runtime.

The scheduler owns two queues of :class:`~nanovllm_dots.engine.sequence.Sequence`:
...
- KV-cache capacity: enforced via :class:`~nanovllm_dots.engine.block_manager.BlockManager`.
...
from nanovllm_dots.engine.sequence import Sequence, SequenceStatus
from nanovllm_dots.engine.block_manager import BlockManager
